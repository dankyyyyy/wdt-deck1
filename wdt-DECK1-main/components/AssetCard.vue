  ...
  <div class="w-50 h-min deck-frame-white">
    ...
    <div class="w-full border-t-2 border-black p-2">
      ...
      <div v-if="asset.category === 'Vessel'">
        ...
        <div class="flex justify-between">
          <label for="limit" class="w-min whitespace-nowrap">Day Rate: </label>
        ...
        <div class="flex justify-between">
          <label for="limit" class="w-min whitespace-nowrap">Transit Time: </label>
          <p class="w-min">{{ asset.transitTime}}h</p>
        </div>
        <div class="flex justify-between">
