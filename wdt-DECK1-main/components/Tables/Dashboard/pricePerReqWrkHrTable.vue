...
export default {
    ...
    setup(props) {
            ...
            if (presetStore.getSelectedPreset() != null) {
                ...
                for (let i = 0; i < assets.length; i++) {
                    ...
                    const row = {
                        ...
                        PriceperWRKHR: `${formatNumberWithDecimal(directCostPerRequiredWorkHour(asset, wtg, location, annualWorkability, props.filterParams.startMonth, props.filterParams.endMonth))}€`,
                    }
        ...
        const columnDefs = useChartStore().perWRKHRLabels.map(label => ({
            headerName: label,
